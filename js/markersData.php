...
// SECTIONS
	let sections = [
		...
		{coordinates:[[3579,3295],[3799,3363],[3901,3594],[3868,3680],[3882,3737],[3739,4110],[3696,4129],[3300,3982],[3269,3917],[3162,3864],[3103,3692],[3183,3466]],color:"green",popup:"<?=$localization['UI']['sorting']['sections']['aelio']['centalCity']?>"},
