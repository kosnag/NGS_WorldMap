...
var marker = 
	...
	L.marker([3333,2606], {icon: Mag}).bindPopup("Mag").addTo(map);
	L.marker([4436,4107], {icon: Mag}).bindPopup("Mag").addTo(map);
	L.marker([1003,4935], {icon: Mag}).bindPopup("Mag").addTo(map);
