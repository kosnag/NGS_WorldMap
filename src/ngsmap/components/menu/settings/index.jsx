  ...
  render() {
    return (
        ...
        >
          ...
          //style={{display: 'none'}}
          >
            <div className='menu-header menu-header-settings'><span className='menu-header-text'><span className="ignore-outline">◆︎</span> Options</span><span className='menu-closebutton' 
