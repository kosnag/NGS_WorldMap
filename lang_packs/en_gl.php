...
$localization = array (
	"UI" => array(
		...
		"sorting" => array(
			...
			"sections" => array(
				"aelio" => array (
					"centalCity" => "Central City",
					"centalAeilo" => "Central Aelio",
					"mtMagnus" => "Mt. Magnus",
					"southAelio" => "South Aelio",
					"northAelio" => "North Aelio",
					"laboratoryRuins" => "Vandord Laboratory Ruins",
					"westAelio" => "West Aelio",
					"resolForest" => "Resol Forest",
					"halphaLake" => "Halpha Lake",
				),
			),
		),
	),
