...
$localization = array (
	...
	"objects" => array(
		...
		"cocoon" => array(
			...
			"7" => "<div class='text-center'> <p class='h4 mb-1'><b>Cocoon</b></p><p class='h5'><b>Fleeting Fight</b></p></div><table class='table table-sm d-flex justify-content-center table-borderless mt-1' style='font-size:14px'> <tbody> <tr> <td><b>Number of players:</b></td><td><b>4</b></td></tr><tr> <td><b>Recommended Battle Power:</b></td><td><b>1184</b></td></tr></tbody></table><p class='mb-0'><b>Description:</b></p><ul style='list-style-type: none'> <li>This is Trainia, where ARKS defenders can test their combat abilities.</li><li>Make use of your battle skills to defeat the Bujin.</li></ul><p class='mb-0'><b>Main Mission:</b></p><ul style='list-style-type: none'> <li>Defeat the Bujin</li></ul><p class='mb-0'><b>Side Mission:</b> <ul style='list-style-type: none'> <li>Clear before 5:00</li><li>Clear without being incapacipated 5 times</li><li>Obtain having taken damage fewer that 20 times</li><li>Complete all Side Missions and clear</li></ul></p><p class='mb-0'><b>1st Clear Reward:</b><ul style='list-style-type: none'> <li>+1 SP</li></ul></p>",
		...
		"ryuker" => array(
			...
			"12" => "<b>Vanford Laboratory Ruins</b>",
			"13" => "<b>Halphia Lake</b>",
			"14" => "<b>Resol Forest</b>",
		),
		"tower" => array(
