...
$localization = array (
	...
	"objects" => array(
		...
		"cocoon" => array(
			"1" => "<div class='text-center'><p class='h4 mb-1'><b>Cocoon</b></p><p class='h5'><b>Enhanced Enemy</b></p></div><table class='table table-sm d-flex justify-content-center table-borderless mt-1' style='font-size:14px'><tbody><tr><td><b>Number of players:</b></td><td><b>?</b></td></tr><tr><td><b>Required Battle Power:</b></td><td><b>???</b></td></tr></tbody></table><p class='mb-0'><b>Description:</b></p><ul style='list-style-type: none'><li>This is Trainia, where ARKS defenders can test their abilities.Defeat the enhanced Pettas Sword using your battle skills.</li></ul><p class='mb-0'><b>Main Mission:</b></p><ul style='list-style-type: none'><li>Defeat the Pettas Sword</li></ul><p class='mb-0'><b>Side Mission:</b> <ul style='list-style-type: none'> <li>Clear before 0:50</li><li>Clear without being incapacitated 5 times</li><li>Clear having taken damage fewer than 5 times</li><li>Complete all Side Missions and clear.</li></ul></p><p class='mb-0'><b>Rewards for 1st clear:</b><ul style='list-style-type: none'> <li>+1 SP</li></ul></p>",
			"2" => "<div class='text-center'><p class='h4 mb-1'><b>Cocoon</b></p><p class='h5'><b>Swift Jump</b></p></div><table class='table table-sm d-flex justify-content-center table-borderless mt-1' style='font-size:14px'><tbody><tr><td><b>Number of players:</b></td><td><b>?</b></td></tr><tr><td><b>Required Battle Power:</b></td><td><b>???</b></td></tr></tbody></table><p class='mb-0'><b>Description:</b></p><ul style='list-style-type: none'><li>This is Trainia, where ARKS defenders can test their abilities.Reach the goal using “Jump” and “Double Jump.”</li></ul><p class='mb-0'><b>Main Mission:</b></p><ul style='list-style-type: none'><li>Reach the finish point</li></ul><p class='mb-0'><b>Side Mission:</b> <ul style='list-style-type: none'> <li>Clear before 1:20</li><li>Clear without fallin 5 times</li><li>Clear having used Glide fewer than 5 times</li><li>Complete all Side Missions and clear.</li></ul></p><p class='mb-0'><b>Rewards for 1st clear:</b><ul style='list-style-type: none'> <li>+1 SP</li></ul></p>",
			"3" => "<div class='text-center'><p class='h4 mb-1'><b>Cocoon</b></p><p class='h5'><b>First Step</b></p></div><table class='table table-sm d-flex justify-content-center table-borderless mt-1' style='font-size:14px'><tbody><tr><td><b>Number of players:</b></td><td><b>?</b></td></tr><tr><td><b>Required Battle Power:</b></td><td><b>???</b></td></tr></tbody></table><p class='mb-0'><b>Description:</b></p><ul style='list-style-type: none'><li>This is Trainia, where ARKS defenders can test their abilities. Follow the instructions to reach the goal while learning the new action.</li></ul><p class='mb-0'><b>Main Mission:</b></p><ul style='list-style-type: none'><li>Reach the finish point!</li></ul><p class='mb-0'><b>Side Mission:</b> <ul style='list-style-type: none'> <li>Clear before 5:00</li><li>Clear before 10:00</li><li>Obtain 10 Point Cubes</li><li>Complete all Side Missions and clear.</li></ul></p><p class='mb-0'><b>Rewards for 1st clear:</b><ul style='list-style-type: none'> <li>+1 SP</li></ul></p>",
		...
		"ryuker" => array(
			...
			"2" => "Mt. Magnus",
			"3" => "Mt. Piccolt",
			"4" => "Halphana Plains: West",
			"5" => "Central City",
			"6" => "Halphana Plains: East",
			"7" => "Halphana Wetlands",
			"8" => "Altolani Plateau",
