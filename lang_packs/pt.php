	...
	"UI" => array(
		...
		"sorting" => array(
			...
			"mainobjects" => array(
				...
				"Cocoons" => "Cocoons",
				"Mags" => "Mags regionais",
				"RyukerDevices" => "Dispositivos Ryuker",
				"Towers" => "Torres",
				"Cities" => "Cidades",
				"Huts" => "Cabanas",
			...
			"sections" => array(
				"aelio" => array (
					"centalCity" => "Cidade Central",
					"centalAeilo" => "Aelio central",
					"mtMagnus" => "Monte Magnus",
					"southAelio" => "Aelio Sul",
					"northAelio" => "Aelio Norte",
					"laboratoryRuins" => "Ruinas do Laboratório",
					"westAelio" => "Aelio Oeste",
					"resolForest" => "Floresta Resol",
					"halphaLake" => "Lago Halpha",
				),
			),
		),
	),
